...
/******/ 	var hotCurrentHash = "4cfc1638c089335ea4c1"; // eslint-disable-line no-unused-vars
...
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"uitest\">\n    <h4>NComp test</h4>\n    <p>This is our planet: {{ planet }}</p>\n\n    {{#wrapped}}{{name}} is awesome.{{/wrapped}}\n\n</div>\n\n<button onclick=\"{{ functions.toggle() }}\">toggle</button>");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".component .uitest {\n  transition: all 250ms ease-in;\n  opacity: 0; }\n\n.component.oppened .uitest {\n  opacity: 1; }\n");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div class=\"test\">\n    <h1>Main NComp</h1>\n    <p>This is our planet: {{ planet }}</p>\n\n    {{#wrapped}}{{name}} is awesome.{{/wrapped}}\n    \n    <!-- functions get's substituted by \"window['NComps'][comp.uuid]\" -->\n    <button onclick=\"{{ functions.close() }}\">Close</button>\n    <button onclick=\"{{ functions.changeName() }}\">Change name</button>\n    <button onclick=\"{{ functions.changePlanet() }}\">Change Planet</button>\n    <p>Comp1: </p>\n    {{#comp}}TestUI{{/comp}}\n    <p>Comp2: </p>\n    {{#comp}}TestUI{{/comp}}\n\n</div>");
